...
export function MobileHeader({
  ...
  return (
    <header className="sticky top-0 z-40 -mx-4 space-y-5 border-b border-outline-ghost/10 bg-surface-low/95 px-4 pb-4 pt-[max(1.25rem,env(safe-area-inset-top))] backdrop-blur-md">
